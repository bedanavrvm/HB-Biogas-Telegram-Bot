    ...
    for item in memberships:
        ...
        if include_cases:
            cases.append({
                ...
                'primary_phone': item.farmer.primary_phone,
                'branch': item.farmer.system_branch or item.farmer.branch,
                'loan_officer': item.farmer.system_loan_officer or item.farmer.jbl_officer,
