...
from .portal_views import (
    ...
    portal_payment_selection_pdf,
    portal_payment_pdf_download,
...
urlpatterns = [
    ...
    path('portal/payments/selection/pdf/', portal_auth_required(portal_payment_selection_pdf), name='portal_payment_selection_pdf'),
    path('portal/payments/pdf/<str:token>/', portal_payment_pdf_download, name='portal_payment_pdf_download'),
