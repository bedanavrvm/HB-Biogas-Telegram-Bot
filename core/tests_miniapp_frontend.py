...
class MiniAppFrontendSmokeTests(TestCase):
    ...
    def test_portal_loads_helper_module_between_utils_and_app(self):
        ...
        self.assertIn('miniapp/portal_farmer_sheet.js?v=75', html)
        ...
        self.assertIn('miniapp/portal.css?v=118', html)
        ...
        self.assertIn('miniapp/portal_payments.js?v=17', html)
        self.assertIn('miniapp/portal_curated_reports.js?v=4', html)
        self.assertIn('miniapp/portal.js?v=92', html)
