...
class LoanOriginationFrontendTests(SimpleTestCase):
    ...
    def test_wizard_and_preview_contract_are_present(self):
        ...
        self.assertIn('data-ui-version="20260826-3"', template)
        self.assertIn("loan_origination.css' %}?v=20260826-3", template)
        self.assertIn("loan_origination.js' %}?v=20260826-3", template)
        ...
        self.assertIn("current?.status === 'fully_signed' ? ''", source)
    ...
    def test_superuser_template_calibration_workspace_is_present(self):
        ...
        self.assertIn('origination_calibration.css\' %}?v=17', template)
        self.assertIn('origination_calibration.js\' %}?v=18', template)
