...
class LoanOriginationFrontendTests(SimpleTestCase):
    ...
    def test_wizard_and_preview_contract_are_present(self):
        ...
        self.assertIn('data-ui-version="20260815-6"', template)
        self.assertIn("loan_origination.css' %}?v=20260815-6", template)
        self.assertIn("loan_origination.js' %}?v=20260815-5", template)
        self.assertIn('const telegramButtonReserve = tg?.MainButton ? 64 : 0', source)
