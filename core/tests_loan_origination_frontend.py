...
class LoanOriginationFrontendTests(SimpleTestCase):
    def test_remote_signing_is_primary_and_assisted_signing_is_explicit(self):
        ...
        self.assertIn("return hasFinalSignedPacket() ? 'Preview signed packet' : fallback;", app_source)
    ...
    def test_wizard_and_preview_contract_are_present(self):
        ...
        self.assertIn('data-ui-version="20260821-5"', template)
        self.assertIn("loan_origination.css' %}?v=20260821-6", template)
        self.assertIn("loan_origination.js' %}?v=20260821-5", template)
