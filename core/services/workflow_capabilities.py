...
_STATIC_CAPABILITIES: tuple[CapabilityDefinition, ...] = (
    ...
    CapabilityDefinition('portal.dashboard.view', 'jawabu_portal', 'View role-tailored Home', 'Home', _roles('JBL_OFFICER', 'CREDIT_ANALYST', 'HB_STAFF', 'BM', 'MANAGEMENT', OPERATIONS_ADMIN_ROLE, 'IT', BUSINESS_ADMIN_ROLE)),
    ...
    CapabilityDefinition('portal.invoice_identity.manage', 'jawabu_portal', 'Verify invoice identity and manage invoice-name changes', 'Invoices', _roles(OPERATIONS_ADMIN_ROLE), ('portal.invoice.view',)),
    ...
    CapabilityDefinition('portal.payment.sequence.manage', 'jawabu_portal', 'Align the official payment number sequence', 'Payments', _roles('IT', OPERATIONS_ADMIN_ROLE)),
    ...
    CapabilityDefinition('portal.origination.view', 'jawabu_portal', 'View loan origination applications', 'Origination', _roles('JBL_OFFICER', 'BM', 'MANAGEMENT', OPERATIONS_ADMIN_ROLE, BUSINESS_ADMIN_ROLE)),
    ...
    CapabilityDefinition('portal.tat.targets.manage', 'jawabu_portal', 'Manage Portal pipeline TAT targets', 'TAT settings', _roles('IT'), ('portal.settings.operations.view',)),
    ...
    # Complaint cases.
    CapabilityDefinition('complaint.queue.view', 'complaint_cases', 'View complaint queue', 'Cases', _roles('OFFICER', 'MANAGER', 'HB_STAFF', 'IT')),
    ...
    *(CapabilityDefinition(
    ...
    CapabilityDefinition('tat.targets.manage', 'tat_tracker', 'Manage TAT targets (legacy)', 'Settings', _roles('IT'), ('tat.home.view',)),
    CapabilityDefinition('tat.settings.targets.propose', 'tat_tracker', 'Propose TAT target changes', 'Settings', _roles('IT'), ('tat.home.view',)),
    CapabilityDefinition('tat.settings.targets.approve', 'tat_tracker', 'Approve TAT target changes', 'Settings', _roles(BUSINESS_ADMIN_ROLE), ('tat.home.view',)),
    CapabilityDefinition('tat.settings.calendar.propose', 'tat_tracker', 'Propose business calendar changes', 'Settings', _roles('IT'), ('tat.home.view',)),
    CapabilityDefinition('tat.settings.calendar.approve', 'tat_tracker', 'Approve business calendar changes', 'Settings', _roles(BUSINESS_ADMIN_ROLE), ('tat.home.view',)),
    ...
    CapabilityDefinition('spin.batch.review', 'spin_credit_analysis', 'Resolve SPIN batch review items', 'Requests', _roles('CREDIT_ANALYST', BUSINESS_ADMIN_ROLE), ('spin.request.view',)),
)
