...
_STATIC_CAPABILITIES: tuple[CapabilityDefinition, ...] = (
    ...
    CapabilityDefinition('complaint.case.create', 'complaint_cases', 'Create complaints', 'Cases', _roles('OFFICER'), ('complaint.queue.view',)),
    ...
    CapabilityDefinition('complaint.case.reopen', 'complaint_cases', 'Reopen complaints', 'Transitions', _roles('OFFICER', 'MANAGER'), ('complaint.queue.view',)),
    ...
    CapabilityDefinition('tat.case.correct', 'tat_tracker', 'Correct TAT case details', 'Cases', _roles('IT', BUSINESS_ADMIN_ROLE), ('tat.home.view',)),
