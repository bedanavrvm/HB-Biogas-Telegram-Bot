...
OPERATIONAL_FIELDS: dict[str, tuple[PublicationField, ...]] = {
    "jawabu_master": (
        ...
        _field("hbg_visit_comment", "JawabuFarmerMaster.comments", ("HBG Visit Comment", "HBG Comment"), "workflow"),
        ...
        _field("case_comment_history", "JawabuCaseComment chronological projection", ("Additional Comments",), "workflow"),
        ...
        _field("installation_report_status", "HomeBiogasAction.installation_report_status", ("Installation Report Submitted to Jawabu",), "workflow"),
        ...
        _field("repayment_date", "JawabuFarmerMaster.repayment_date", ("Preferred Repayment Date", "Preferred Repayment Day", "Repayment Date", "Repayment Dates", "Repayment Day"), "financial"),
    ...
    "internal_order": (
        ...
        _field("repayment_date", "JawabuFarmerMaster.repayment_date", ("PREFERRED REPAYMENT DATE", "PREFERRED REPAYMENT DAY", "REPAYMENT DATE", "Repayment Date", "Repayment Day"), "financial"),
        _field("repayment_tenor", "JawabuFarmerMaster.repayment_tenor", ("TENOR", "Repayment Tenor"), "financial"),
        _field("payment_product", "JawabuFarmerMaster.payment_product", ("PAYMENT PRODUCT", "Product", "Product Name"), "financial"),
