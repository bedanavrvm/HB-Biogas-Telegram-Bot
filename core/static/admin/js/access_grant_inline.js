(function () {
  ...
  function updateAll() {
    document.querySelectorAll('.inline-related, [data-scope-card]').forEach(updateRow);
  }
  ...
  document.addEventListener('change', function (event) {
    ...
    const row = event.target.closest('.inline-related, #enroll-telegram-user, [data-scope-card]');
