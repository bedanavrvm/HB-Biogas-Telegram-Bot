...
(() => {
  ...
  function render() {
    ...
    window.MiniAppComponents?.bindTableZoom?.(state.root.querySelector('[data-miniapp-table-zoom="portal-report"]'), 'portal-report-table-zoom');
    renderCharts();
