...
class TatTrackerWorkflowTest(TestCase):
    ...
    def test_dm_task_launch_is_consumed_and_queue_navigation_does_not_reload_it(self):
        ...
        self.assertIn("miniapp/tat_tracker.js' %}?v=102", template)
    ...
    def test_credit_assessment_uses_staff_inputs_and_in_app_pdf_preview(self):
        ...
        self.assertIn('function downloadAssessmentDocument(button)', source)
        ...
        self.assertIn('{% if credit_assessment_enabled %}', template)
    ...
    def test_compact_home_has_filter_sheet_metrics_and_explicit_pagination(self):
        ...
        self.assertIn('</label>\n          <small id="newCaseAmountHelp"', template)
        self.assertIn('class="amount-range-help new-case-amount-help"', template)
        self.assertIn('.new-case-amount-help { grid-column: 2;', stylesheet)
        ...
        self.assertIn('utils.bindMiniAppTheme?.(tg, refreshTatVisualTheme)', source)
        self.assertIn(':root[data-miniapp-color-scheme="dark"]', stylesheet)
    ...
    def test_tat_report_ui_reuses_vendored_grid_and_compact_correction_actions(self):
        ...
        self.assertIn('data-required-capability="tat.reports.view" hidden', template)
        self.assertIn('data-required-capability="tat.case.create" hidden', template)
        self.assertIn('data-required-capability="tat.case.search" hidden', template)
        self.assertIn('[data-required-capability][hidden] { display: none !important; }', stylesheet)
