...
| **Complaint reference** | The globally unique sequential staff-facing identifier such as `CMP000001`. Source Telegram/message IDs remain immutable internal deduplication keys and are not the operational reference shown to staff. |
